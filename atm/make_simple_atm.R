...
rfmdir	    = "~/18co2/rfm/"
atmfile     = paste(rfmdir,"atm/Ts",Ts,"_gamma_st",gamma_st,"_rh",rh,"_q",co2_ppmv,".atm",sep="")
#atmfile     = paste(rfmdir,"atm/Ts",Ts,"_isothermal_q",co2_ppmv,".atm",sep="")
...
if (gamma != "m"){
   ...
   for (k in 2:nz){
      tabs[k] = tabs[k-1] - gamma*(diff(z)[k-1])
